...
( function(window) {
    ...
    ///// FRAMEWORK LAYOUTS /////
    var ISF_Layout_GalleryPreview = require('layouts/gallery-preview/script.js');
    ...
    InteractivePage.prototype.init = function() {
        ...
        // init Gallery Previews
        this.layouts.galleryPreviews = [];
        Array.from( this.DOM.story.querySelectorAll( CLASSES.GALLERY_PREVIEW.EL ) ).forEach(function(item) {
            self.layouts.galleryPreviews.push(new ISF_Layout_GalleryPreview(item, controller));
        });
...
},{"classes.js":24,"helpers/removebadthings.js":29,"imagesLoaded":21,"layouts/gallery-preview/script.js":32,"scrollmagic":22}],24:[function(require,module,exports){
...
/* Helper Functions */
var toggleScroll = require("helpers/togglescroll.js");
var calcWinsize = require("helpers/calcwinsize.js");
...
},{"classes.js":24,"gsap":19,"helpers/calcwinsize.js":25,"helpers/createdomel.js":26,"helpers/extend.js":27,"helpers/togglescroll.js":30,"scrollmagic":22}],32:[function(require,module,exports){
...
var BRevealer = require("layouts/gallery-preview/block-revealer.js");
...
function ISF_Layout_GalleryPreview(el, controller) {

    this.controller = controller;

    this.DOM = {};
    this.DOM.el = el;
    this.DOM.imgs = Array.from(this.DOM.el.querySelectorAll(".isf-layout_gallery-preview__inner .isf-el_image"));
    this.DOM.previewTriggers = Array.from( this.DOM.el.querySelectorAll(".js--el_preview__trigger") );

    this.DOM.preview = this.DOM.el.querySelector( ".js--gallery-preview__preview" );
    this.DOM.previewImg = this.DOM.preview.querySelector(".isf-el_image");
...
ISF_Layout_GalleryPreview.prototype.init = function(){
    this.buildBlockRevealers();
    this.setupScrollScenes();
    this.setupPreviewEvents();
};

ISF_Layout_GalleryPreview.prototype.buildBlockRevealers = function(){
    ...
    this.DOM.imgs.forEach( function(img, ind) {
        var col = getRandomInt(0, 2);
        self.blockRevealers.push( new BRevealer(img, {
            revealSettings : {
                bgcolor: colors[col],
                duration: 0.3,
                easing: Expo.easeOut
    ...
    var colpreview = getRandomInt(0, 2);
    this.blockRevealerPreview = new BRevealer( this.DOM.previewImg, {
        revealSettings : {
            bgcolor: colors[colpreview],
            duration: 0.3,
            easing: Expo.easeOut
        }
    });
...
ISF_Layout_GalleryPreview.prototype.setupPreviewEvents = function(){

    var self = this;

    // open on click
    this.DOM.previewTriggers.forEach( function(trigger, ind) {
        trigger.addEventListener( 'click', function(e) {
            e.preventDefault();
            self.toggleRevealers( 'hide', self.openPreview.bind(this, self, trigger) );
        });
    });

    // close on clicking anywhere
    this.DOM.preview.addEventListener( 'click', function() {
        self.closePreview();
        self.blockRevealers.forEach( function(br, ind) {
            br.isRevealed = false;
        });
        setTimeout(function(){
            self.toggleRevealers( 'reveal' );
        }, 600);
    });
};

ISF_Layout_GalleryPreview.prototype.toggleRevealers = function(action, callback){

    var self = this;

    this.blockRevealers.forEach( function(br, ind) {
        if( action === 'hide' ){
            br.hide();
        } else {
            br.reveal();
...
ISF_Layout_GalleryPreview.prototype.setupScrollScenes = function(){

    // reveal blocks on page enter
    var self = this;
    this.blockRevealers.forEach(function(br, ind) {
        var scene = new ScrollMagic.Scene({
            triggerElement: br.DOM.el,
            triggerHook: 0.6
        })
            .on("enter", function(){
                if( !br.isRevealed ){
...
ISF_Layout_GalleryPreview.prototype.openPreview = function( selfel, trigger ){

    var triggerBR = trigger.querySelector(".block-revealer");
    var previewBR = selfel.blockRevealerPreview.DOM.el;

    var triggerColor = trigger.querySelector(".block-revealer__element").style.backgroundColor;

    // change preview content el to the trigger one
    previewBR.querySelector(".block-revealer__content").innerHTML = triggerBR.querySelector(".block-revealer__content").innerHTML;
    previewBR.querySelector(".block-revealer__element").style.backgroundColor = triggerColor;

    // open preview el
    selfel.DOM.preview.classList.add("is--open");

    // reveal
    setTimeout(function(){
        selfel.blockRevealerPreview.reveal();
    }, 600);
};

ISF_Layout_GalleryPreview.prototype.closePreview = function(){
    var self = this;
    this.blockRevealerPreview.hide();
    setTimeout(function(){
        self.DOM.preview.classList.remove("is--open");
    }, 600);
};

module.exports = ISF_Layout_GalleryPreview;
...
},{"animated-scroll-to":1,"browsernizr":2,"browsernizr/test/touchevents":17,"classes.js":24,"gsap":19,"hammerjs":20,"helpers/calcwinsize.js":25,"helpers/createdomel.js":26,"helpers/extend.js":27,"helpers/getrandomint.js":28,"helpers/togglescroll.js":30,"layouts/gallery-preview/block-revealer.js":31,"scrollmagic":22}]},{},[23]);
