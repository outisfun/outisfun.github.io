...
( function(window) {
    ...
    // effects
    var ISF_X_Letters = require('effects/letters/script.js');
    ...
    function InteractivePage(el) {
        ...
        this.effects = {};
        this.effects.x_letters = ISF_X_Letters;
...
/* To use the effect
	-- add a data attribute data-x_letters = "effect"
