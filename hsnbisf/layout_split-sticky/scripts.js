...
( function(window) {
    ...
    ///// FRAMEWORK LAYOUTS /////
    var ISF_Layout_SplitSticky = require('layouts/split-sticky/script.js');
    ...
    InteractivePage.prototype.init = function() {
        ...
        this.layouts.splitStickys = [];
        Array.from( this.DOM.story.querySelectorAll( CLASSES.SPLIT_STICKY.EL ) ).forEach(function(item) {
            self.layouts.splitStickys.push(new ISF_Layout_SplitSticky(item, controller));
        });
...
},{"classes.js":7,"gsap":2,"helpers/removebadthings.js":8,"imagesLoaded":3,"layouts/split-sticky/script.js":9,"scrollmagic":4,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":5}],7:[function(require,module,exports){
...
function ISF_Layout_SplitSticky(el, controller) {
    ...
    this.DOM = {el: el};
    this.DOM.sticky = this.DOM.el.querySelector( CLASSES.SPLIT_STICKY.STICKY );
