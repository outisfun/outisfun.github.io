...
( function(window) {
    ...
    ///// FRAMEWORK LAYOUTS /////
    var ISF_Layout_InteractiveScroller = require('layouts/interactive-scroller/script.js');
    ...
    InteractivePage.prototype.init = function() {
        ...
        this.layouts.interactiveScrollers = [];
        Array.from( this.DOM.story.querySelectorAll( CLASSES.INTERACTIVE_SCROLLER.EL ) ).forEach(function(item) {
            self.layouts.interactiveScrollers.push(new ISF_Layout_InteractiveScroller(item, controller));
        });
...
},{"classes.js":25,"gsap":19,"helpers/removebadthings.js":31,"imagesLoaded":21,"layouts/interactive-scroller/script.js":32,"scrollmagic":22,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":23}],25:[function(require,module,exports){
...
function ISF_Layout_InteractiveScroller(el, controller) {
    ...
    //an object to store DOM elements
    this.DOM = {};
    this.DOM.el = el;
    this.DOM.viewer = this.DOM.el.querySelector( CLASSES.INTERACTIVE_SCROLLER.VIEWER );

    this.DOM.steps = Array.from(this.DOM.el.querySelectorAll( CLASSES.INTERACTIVE_SCROLLER.STEP ));
    this.stepsScenes = [];
...
ISF_Layout_InteractiveScroller.prototype.setupScrollScenes = function(){
    ...
    introTL.fromTo(this.DOM.intro.querySelector(".isf-group__background"), 1,
        {
            scale: 1.5,
        },
        {
    ...
    introTL.fromTo(this.DOM.intro.querySelector(".isf-group__background .overlay"), 1,
        {
            opacity: 0.3,
        },
        {
    ...
    introTL.fromTo(this.DOM.intro.querySelector(".isf-group__item"), 1,
        {
            opacity: 1,
            top: '20%'
        },
...
ISF_Layout_InteractiveScroller.prototype.buildStepIndicator = function( stepNumber ){
...
ISF_Layout_InteractiveScroller.prototype.activateSteps = function(){
    ...
    this.DOM.steps.forEach(function(step, ind) {
        ...
        if( (stepNumber !== 'start') && (stepNumber !== 'end') ) {
            // build indicator
            self.buildStepIndicator( stepNumber );

            // create scrollmagic scenes for each step to trigger content changes in the viewer
            ...
            var scene = new ScrollMagic.Scene({
                ...
                .on('enter', function() {
                    ...
                    console.log( step, correspondingContentGroup );
                })
...
},{"animated-scroll-to":1,"browsernizr":2,"browsernizr/test/touchevents":17,"classes.js":25,"gsap":19,"hammerjs":20,"helpers/clamp.js":26,"helpers/gettranslatex.js":27,"helpers/isenteringviewport.js":28,"helpers/isinviewport.js":29,"helpers/maprange.js":30,"scrollmagic":22}]},{},[24]);
