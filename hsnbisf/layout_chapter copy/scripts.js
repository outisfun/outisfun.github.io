...
( function(window) {
    ...
    ///// FRAMEWORK LAYOUTS /////
    var ISF_Layout_Chapter = require('layouts/chapter/script.js');
    ...
    InteractivePage.prototype.init = function() {
        ...
        var self = this;
        // init Chapter
        this.layouts.chapters = [];
        Array.from( this.DOM.story.querySelectorAll(CLASSES.CHAPTER.EL) ).forEach(function(item) {

            self.layouts.chapters.push(new ISF_Layout_Chapter(item, controller));
        });
    };
...
},{"classes.js":7,"gsap":2,"helpers/removebadthings.js":8,"imagesLoaded":3,"layouts/chapter/script.js":9,"scrollmagic":4,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":5}],7:[function(require,module,exports){
