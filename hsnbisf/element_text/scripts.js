...
( function(window) {
    ...
    InteractivePage.prototype.init = function() {
        ...
        // init elems
        this.elems.basic = [];
        Array.from( this.DOM.story.querySelectorAll(CLASSES.EL.EL) ).forEach(function(item) {
...
},{"classes.js":7,"elements/basic/script.js":9,"gsap":2,"helpers/removebadthings.js":8,"imagesLoaded":3,"scrollmagic":4,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":5}],7:[function(require,module,exports){
