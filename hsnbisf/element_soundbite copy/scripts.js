...
(function() {
  ...
  module.exports = {howl: Howl, howler: Howler};
})();
...
( function(window) {
    ...
    // elements
    var ISF_SoundBite = require('elements/soundbite/script.js');
    ...
    InteractivePage.prototype.init = function() {
        ...
        // init elems
        this.elems.soundbites = [];
        Array.from( this.DOM.story.querySelectorAll(CLASSES.SOUNDBITE.EL) ).forEach(function(item) {
            self.elems.soundbites.push(new ISF_SoundBite(item, controller));
        });
    };
...
},{"classes.js":10,"elements/soundbite/script.js":12,"gsap":2,"helpers/removebadthings.js":11,"imagesLoaded":4,"scrollmagic":6,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":7}],10:[function(require,module,exports){
...
// Plugins
var hls = require('howler/dist/howlermods.js');
var Howl = hls.howl;
var Howler = hls.howler;
var SiriWave = require('siriwave/dist/siriwave.js');

var ww = window.innerWidth;

function ISF_SoundBite(el, manager) {
	this.DOM = {el: el};
	this.DOM.canvas = this.DOM.el.querySelector(".isf-el_soundbite__canvas");
	this.DOM.trigger = this.DOM.el.querySelector(".isf-el_soundbite__trigger");
	this.DOM.progress = this.DOM.el.querySelector(".isf-el_soundbite__progress");
	this.DOM.icon = this.DOM.el.querySelector("ion-icon");
	this.soundsrc = this.DOM.el.dataset.soundsrc;
...
ISF_SoundBite.prototype.init = function() {
    //console.log('init soundbite', SiriWave);
	// siriwave
	var cw = (ww >= 768) ? 360 : 200;
	var ch = (ww >= 768) ? 180 : 120;

	this.siriWave = new SiriWave({
		container: this.DOM.canvas,
		style: 'ios',
		width: cw,
		height: ch,
		frequency: 3,
    ...
    this.howl = new Howl({
        ...
        onplay: function() {
            self.siriWave.start();
            self.siriWave.setAmplitude(0.6);
            self.siriWave.setSpeed(0.1);
            self.DOM.icon.name = "pause";
            console.log(self.siriWave);
...
ISF_SoundBite.prototype.play = function() {
    this.howl.play();
    this.DOM.icon.name = 'pause';
    this.isPlaying = true;
};

ISF_SoundBite.prototype.pause = function() {
    this.howl.pause();
    this.DOM.icon.name = 'play';
    this.isPlaying = false;
};

ISF_SoundBite.prototype.step = function() {
	var self = this;

	var seek = this.howl.seek() || 0;
	TweenLite.to(self.DOM.progress, 1, {
		width: (((seek / self.howl.duration()) * 100) || 0) + '%'
	});
...
module.exports = ISF_SoundBite;

},{"classes.js":10,"howler/dist/howlermods.js":3,"siriwave/dist/siriwave.js":8}]},{},[9]);
