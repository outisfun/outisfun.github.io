...
},{"el_horscroll.js":6,"scrollmagic":3}],6:[function(require,module,exports){
// Plugins
var ScrollMagic = require('scrollmagic');
...
XPR_ScrollerHor.prototype.exit = function( dir ){
    ...
    if( dir === 'up' ){
        setTimeout(function(){
          self.controller.scrollTo(self.DOM.el.offsetTop - 0.3*wh);
        }, 300);
    } else {
        setTimeout(function(){
          self.controller.scrollTo(self.DOM.el.offsetTop + 0.3*wh);
    ...
    setTimeout(function(){
      self.fixViewport = true; // enable fixing it again
    }, 800);
};
...
},{"el_horscroll_item.js":7,"gsap":1,"hammerjs":2,"scrollmagic":3,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":4}],7:[function(require,module,exports){
