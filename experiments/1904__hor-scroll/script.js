...
},{"gsap/umd/TweenLite":4}],4:[function(require,module,exports){
(function (global){
"use strict";
...
( function(window) {
    ...
    var XPR_ScrollerHor = require( 'el_horscroll.js' );
...
},{"el_horscroll.js":11,"scrollmagic":7}],9:[function(require,module,exports){
...
// on initing the manager, we need to generate two tweens:
// one turning from (blue blue) -> (blue black)
// the other tween end one is (black blue) -> blue blue

function ColorManager(el, left, right){
  this.el = el;
  var self = this;
  ...
  this.setColors(left, right); // set initial colors
}

ColorManager.prototype.setColors = function(col1, col2){
  var self = this;
  ...
  if(isChrome){
    // used to be this
    TweenLite.set(self.el, {backgroundImage:"-webkit-linear-gradient(-35deg," + col1 + ", " + col2  + ")"});
    //TweenLite.set(element, {background:"-webkit-linear-gradient(top," + colors.top + ", " + colors.bottom + ")"});
  } else {
    TweenLite.set(self.el, {background:"linear-gradient(-35deg," + col1 + ", " + col2 + ")"});
  }
};

ColorManager.prototype.step = function(col1end, col2end){
  var self = this;
  TweenMax.to(this.colors, 1, {
    colorProps:{
      left: col1end,
      right: col2end
    },
    onUpdate: self.colorize,
    onUpdateParams:[ self ]
  });
};

ColorManager.prototype.colorize = function( el ){

  var self = el;
  if(isChrome){
    TweenLite.set(self.el, {backgroundImage:"-webkit-linear-gradient(-35deg," + el.colors.left + ", " + el.colors.right + ")"});
  } else {
    TweenLite.set(self.el, {background:"linear-gradient(-45deg," + el.colors.left + ", " + el.colors.right + ")"});
  }
};
...
},{"charming":2,"helpers/lineeq.js":14,"scrollmagic":7}],11:[function(require,module,exports){
// Plugins
var ScrollMagic = require('scrollmagic');
...
var XPR_ScrollerHorItem = require( 'el_horscroll_item.js' );
var XPR_ScrollerHorNav = require( 'el_horscroll_nav.js' );
var ColorManager = require('colormanager.js'); // An object to manage gradient transitions
...
function XPR_ScrollerHor(el, controller){
  ...
  this.DOM.scenesBgStart = this.DOM.el.querySelector( ".background--start" );
  this.DOM.scenesBgEnd = this.DOM.el.querySelector( ".background--end" );
  ...
  this.nav = new XPR_ScrollerHorNav( this.DOM.nav );
...
XPR_ScrollerHor.prototype.exit = function( dir ){
    ...
    animateScrollTo((self.DOM.el.offsetTop), {
      speed: 0,
      onComplete: function() {
        setTimeout(function(){
...
module.exports = XPR_ScrollerHor;
...
},{"animated-scroll-to":1,"colormanager.js":9,"el_horscroll_item.js":12,"el_horscroll_nav.js":13,"gsap":5,"gsap/umd/ColorPropsPlugin.js":3,"hammerjs":6,"scrollmagic":7}],12:[function(require,module,exports){



// Items within the Hor Scroll

var Letters = require( 'effects/letters.js' );
...
XPR_HorScrollItem.prototype.init = function(){
  var self = this;
...
},{"effects/letters.js":10}],13:[function(require,module,exports){
...
function XPR_HorScrollNav(el){
  this.DOM = {el: el};

  this.DOM.sideways = this.DOM.el.querySelector( ".xpr-horscroll__nav__sideways" );
  this.DOM.up = this.DOM.el.querySelector( ".xpr-horscroll__nav__up" );
  this.DOM.down = this.DOM.el.querySelector( ".xpr-horscroll__nav__down" );
...
XPR_HorScrollNav.prototype.init = function(){

};

XPR_HorScrollNav.prototype.update = function( up, down, side ){
  if( up === true ){
    this.canExitUp = true;
    this.DOM.up.classList.add( 'is--visible' );
  } else {
  ...
  if( down === true ){
    ...
    this.canExitDown = false;
    this.DOM.down.classList.remove( 'is--visible' );
  }
  if( side === true ){
...
module.exports = XPR_HorScrollNav;
