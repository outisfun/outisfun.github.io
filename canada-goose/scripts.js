...
},{"./lib/Modernizr":2,"./lib/ModernizrProto":3,"./lib/classes":5,"./lib/setClasses":24,"./lib/testRunner":28}],2:[function(require,module,exports){
...
},{"./ModernizrProto.js":3,"./cssomPrefixes.js":10}],5:[function(require,module,exports){
...
},{"./isSVG.js":18}],9:[function(require,module,exports){
...
},{"./ModernizrProto.js":3,"./omPrefixes.js":22}],11:[function(require,module,exports){
...
},{"./ModernizrProto.js":3,"./omPrefixes.js":22}],13:[function(require,module,exports){
...
},{"./createElement.js":8,"./isSVG.js":18}],16:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":3,"./createElement.js":8,"./docElement.js":11,"./getBody.js":15}],17:[function(require,module,exports){
...
},{"./docElement.js":11}],19:[function(require,module,exports){
...
},{"./Modernizr.js":2,"./createElement.js":8}],21:[function(require,module,exports){
...
},{"./computedStyle.js":6,"./domToCSS.js":13,"./injectElementWithStyles.js":16}],22:[function(require,module,exports){
...
},{"./ModernizrProto.js":3,"./atRule.js":4,"./cssToDOM.js":9,"./testPropsAll.js":27}],24:[function(require,module,exports){
var Modernizr = require('./Modernizr.js');
var docElement = require('./docElement.js');
var isSVG = require('./isSVG.js');
  /**
...
},{"./Modernizr.js":2,"./docElement.js":11,"./isSVG.js":18}],25:[function(require,module,exports){
...
},{"./fnBind.js":14,"./is.js":17}],26:[function(require,module,exports){
...
},{"./contains.js":7,"./createElement.js":8,"./cssToDOM.js":9,"./is.js":17,"./mStyle.js":19,"./nativeTestProps.js":21}],27:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":3,"./cssomPrefixes.js":10,"./domPrefixes.js":12,"./is.js":17,"./testDOMProps.js":25,"./testProps.js":26}],28:[function(require,module,exports){
var tests = require('./tests.js');
var Modernizr = require('./Modernizr.js');
...
},{"./Modernizr.js":2,"./classes.js":5,"./is.js":17,"./tests.js":29}],29:[function(require,module,exports){
...
},{"./../../lib/Modernizr.js":2,"./../../lib/createElement.js":8}],31:[function(require,module,exports){
/*!
{
  "name": "Filesystem API",
  "property": "filesystem",
...
},{"./../../lib/Modernizr.js":2,"./../../lib/prefixed.js":23}],32:[function(require,module,exports){
/*!
{
...
},{"./../lib/Modernizr.js":2}],33:[function(require,module,exports){
...
},{"ev-emitter":34}],37:[function(require,module,exports){
/*!
...
},{"gsap":35,"scrollmagic":37}],39:[function(require,module,exports){
...
var WebGL = require("tools/webgl.js");
var GL = require("tools/gl-obj.js");
var loadF = require("tools/image-loader.js");
var loadImages = loadF.loadImages;
var createCanvas = require("tools/create-canvas.js");

var random = function(from=null,to=null,interpolation=null){
      if(from==null){
        from=0;
        to=1;
...
var vertShader = "precision mediump float;\n#define GLSLIFY 1\n\nattribute vec2 a_position;\n\nvoid main() {\n   gl_Position = vec4(a_position,0.0,1.0);\n}\n";
...
module.exports = RainRenderer;

},{"tools/create-canvas.js":52,"tools/gl-obj.js":53,"tools/image-loader.js":54,"tools/webgl.js":57}],41:[function(require,module,exports){
var loadImages = require("tools/image-loader.js");
var times = require("tools/times.js");
var createCanvas = require("tools/create-canvas.js");
var chance = require("tools/random.js").chance;
var random = require("tools/random.js").random;
...
},{"tools/create-canvas.js":52,"tools/image-loader.js":54,"tools/random.js":55,"tools/times.js":56}],42:[function(require,module,exports){
...
module.exports = function(type, className, content) {
...
module.exports = function(y2, y1, x2, x1, currentVal) {
    const m = (y2 - y1) / (x2 - x1);
    const b = y1 - m * x1;
...
module.exports = function(num, in_min, in_max, out_min, out_max)  {
...
GL.prototype={
  ...
  init(canvas,options,vert,frag){
    ...
    console.log("this gl", this.gl, canvas, options);
...
},{"tools/webgl.js":57}],54:[function(require,module,exports){


module.exports = {
    loadImage: function(src,i,onLoad){
    ...
    loadImages: function(images,onLoad){
        var self = this;
        var lImage = function(src,i,onLoad){
          return new Promise((resolve,reject)=>{
            if(typeof src=="string"){
              src={
                name:"image"+i,
        ...
        return Promise.all(images.map((src,i)=>{
            return lImage(src,i,onLoad);
        }));
    },
    ImageLoader: function(images,onLoad){
        var self = this;
      return new Promise((resolve,reject)=>{
        self.loadImages(images,onLoad).then((loadedImages)=>{
          let r={};
...
module.exports = {
    ...
    random: function(from=null,to=null,interpolation=null){
      if(from==null){
        from=0;
        to=1;
      }else if(from!=null && to==null){
...
module.exports = {
    ...
    console.log(gl, vertexScript, fragScript);
    ...
    createTexture: function(gl,source,i){
...
module.exports = function(mod, controller) {
	var effect = mod.DOM.el.dataset.isf_animate_on_page_enter;
	mod.DOM.el.classList.add('animate');
	mod.DOM.el.classList.add('animate--' + effect);

	mod.scrollScene = new ScrollMagic.Scene({
		triggerElement: mod.DOM.el,
        triggerHook: 0.6
	})
		.setClassToggle((mod.DOM.el), 'is--active')
        .addTo(controller);
};

},{"scrollmagic":37}],60:[function(require,module,exports){
...
var createDOMEl = require("helpers/createdomel.js");

module.exports = function(mod, controller, options){
    //create another object out of the DOM el of the module
    var rev = new BlockRevealer(mod.DOM.el, options);
    //init block reveal on scroll
    var revScene = new ScrollMagic.Scene({
        triggerElement: rev.DOM.el,
        triggerHook: 0.6
    })
        .on("enter", function(){
            rev.reveal();
...
function BlockRevealer(el, options) {
    this.DOM = {el: el};
    this.options = extend({}, this.options);
    //overwrites them?
    extend(this.options, options);
    console.log(this.options.hasOwnProperty('revealSettings'));
    console.log(this.options.revealSettings.hasOwnProperty('direction'));
    this.init();
}

BlockRevealer.prototype.options = {
    // If true, then the content will be hidden until it´s "revealed".
    isContentHidden: true
};

BlockRevealer.prototype.init = function() {
    this.layout();
};

BlockRevealer.prototype.layout = function() {
...
BlockRevealer.prototype.getTransformSettings = function(direction) {
 ...
 */
BlockRevealer.prototype.reveal = function(revealSettings) {
...
},{"helpers/createdomel.js":44,"helpers/extend.js":45,"scrollmagic":37}],61:[function(require,module,exports){
...
/* To use the effect
    ...
    The current effect makes a headline appear with a cool animation.
    It can appear on either page enter or when it's made active, so it probably makes more sense to
    define the transforms based on the parent class

    Based on the Codrops article: https://tympanus.net/codrops/2016/10/18/inspiration-for-letter-effects/
*/

var ScrollMagic = require("scrollmagic");
var lineEq = require("helpers/lineeq.js");
var charming = require("charming");

module.exports = function(mod, controller, options){
    //construct the object
    var tfx = new TextFx(mod.DOM.el, controller, options);
    //how to make this applicable to multi-line objects? like quotes?
    //what if the heading is many lines?
...
function TextFx(el, controller, options) {
    ...
    this.opts = options;
    this.fx = el.dataset.isf_letters;
    this.isAnimated = false;

    console.log(this.DOM.lines);
...
TextFx.prototype.animate = function(direction, effect, callback) {
    ...
    this.DOM.lines.forEach(function(ln, index) {
        setTimeout(function(){
            TweenMax.staggerFromTo(ln.querySelectorAll("span"), 2,
...
},{"charming":33,"helpers/lineeq.js":48,"scrollmagic":37}],62:[function(require,module,exports){

/* PARALLAX EFFECT */

/* Lets the element move with a higher or slower speed than the normal scroll on the page */
// The effect is activated when the app discovers a data attribute data--isf_parallax
// The value of the attribute is the amount of parallax applied - light, medium, strong

var ScrollMagic = require("scrollmagic");

module.exports = function(isf_el, controller) {

    //parallax trigger el should be the parent
    //otherwise weird glitch happens as it goes in and out of the scrollscene
    var parentEl = isf_el.DOM.el.parentNode;

    if (isf_el.DOM.el.dataset.isf_parallax) {
        // par value
        var par;
        switch(isf_el.DOM.el.dataset.isf_parallax) {
            case 'light':
                par = 20;
                break;
            case 'medium':
        ...
        //differentiate scroll direction?
        var parallaxTimeline = new TimelineLite()
            .add([
                TweenLite.fromTo(isf_el.DOM.el, 1,
                {
                    y: (par) + '%'
                },
                {
...
},{"scrollmagic":37}],63:[function(require,module,exports){



var RainRenderer = require("effect-rain/rain-renderer.js");
var Raindrops = require("effect-rain/raindrops.js");
var loadF = require("tools/image-loader.js");
var loadImage = loadF.loadImage;
var loadImages = loadF.loadImages;
var createCanvas = require("tools/create-canvas.js");
var ScrollMagic = require("scrollmagic");
...
var times = require("tools/times.js");
var {random, chance} = require("tools/random.js");
...
/* BASIC ELEMENT CLASS TO ALLOW FOR INTEGRATION WITH IS FEATURES LIKE EFFECTS ETC */

var ScrollMagic = require('scrollmagic');
var CLASSES = require('classes.js');

function ISF_El(el, controller) {
    this.controller = controller;
    this.DOM = {el: el};
};

module.exports = ISF_El;

},{"classes.js":39,"scrollmagic":37}],65:[function(require,module,exports){

var ScrollMagic = require('scrollmagic');
var CLASSES = require('classes.js');

function ISF_Chapter(el, controller) {
  this.controller = controller;
  this.DOM = { el : el };
  this.DOM.header = this.DOM.el.querySelector(CLASSES.CHAPTER.HEADER);
  this.DOM.contents = this.DOM.el.querySelector(CLASSES.CHAPTER.CONTENT);
  this.chapterContentGroupScenes = [];
  this.initEvents();
}

ISF_Chapter.prototype.initEvents = function () {
  this.fixHeader();
};

ISF_Chapter.prototype.fixHeader = function () {
  ...
  this.chapterHeaderScene = new ScrollMagic.Scene({
    ...
    triggerHook: 0,
    duration: this.DOM.el.clientHeight - wh,
  })
    .on('end', function(){
      self.DOM.el.classList.toggle(CLASSES.CHAPTER.JS__BOTTOM);
    })
    .setClassToggle(this.DOM.el, CLASSES.CHAPTER.JS__FIXED)
    .addTo(this.controller);

  this.chapterHeaderSceneDarken = new ScrollMagic.Scene({
    triggerElement: this.DOM.contents,
    triggerHook: 0.9,
  })
    .setClassToggle(this.DOM.el, CLASSES.CHAPTER.JS__DARKENED)
    .addTo(this.controller);

    // var fadeTween = TweenMax.fromTo( this.DOM.el.querySelector( ".isf-el_chapter__img" ), 1,
    //     {
    //         opacity: 1
    //     },
    //     {
    ...
    // var viewerFade = new ScrollMagic.Scene({
    //     triggerElement: this.DOM.el,
    //     triggerHook: 0.5,
...
module.exports = ISF_Chapter;


},{"classes.js":39,"scrollmagic":37}],66:[function(require,module,exports){
...
// Helper Functions
var ClickOrTouch = require("helpers/clickortouch.js");
var getRandomInt = require("helpers/getrandomint.js");
var getMousePos = require("helpers/getmousepos.js");
var lineEq = require("helpers/lineeq.js");
var shuffleArray = require("helpers/shufflearray.js");
var TouchManager = require("touchmanager.js");

function ISF_Collage(el, controller) {

    this.DOM = {el: el};
    this.items = [];
    this.itemSequence = []; //store a random sequence of the numbers
    this.itemSequenceCounter = 0; //tracks where in the array we are
    this.trigger = this.DOM.el.querySelector(CLASSES.COLLAGE.TRIGGER);

    //get all items that will appear in the collage
    this.allItems = Array.from(document.querySelectorAll(CLASSES.COLLAGE.ITEM));
    this.initEvents();
}

ISF_Collage.prototype.initEvents = function() {

    var self = this;
    //create an array of numbers and shuffle it to simulate randomness
    //and avoid repeating images
    for (var i = 0; i < this.allItems.length; i += 1){
        self.itemSequence.push(i);
    }
    this.itemSequence = shuffleArray(this.itemSequence);

    // Necessary to differentiate between click and touch events
    // to finetune behavior on mobile devices
    var clickEvent = ClickOrTouch();
    var endOfClickEvent = ( clickEvent === 'touchstart' ) ? 'touchend' : 'mouseup';

    // Necessary to differentiate between tap and scroll: duration and touch distance
    var touchTime;
    var currentEvent;
    var scrollTop;

    this.trigger.addEventListener(clickEvent, function(e) {
        //record original event to be able to preventDefault it afterwards;
        currentEvent = e;
        console.log(e);
        if (clickEvent === 'touchstart') {
            //record the initial event because it contains touches.pageX/pageY,
            //and scrolltop to determine whether the user scrolled on mobile
    ...
    this.trigger.addEventListener( endOfClickEvent, function(e) {

        if (endOfClickEvent === 'touchend') {
            var diff = new Date().getTime() - touchTime;
            var currentScroll = window.pageYOffset;
            if( (currentScroll - scrollTop) < 20 ) {
                //regard it as tap and prevent default.
                e.preventDefault();
                if (diff < 100) {
                    self.addItem(e, currentEvent);
                }
            }
        } else {
            //handle it like a click
            self.addItem(e);
        }
    });
};

ISF_Collage.prototype.addItem = function(ev, touchEvent) {

    var self = this;
    console.log(ev);
    //get position vars
    var gridOffset = this.DOM.el.getBoundingClientRect().top + window.scrollY;

    var relPosX = (TouchManager.clickOrTouch(ev) === 'touchstart') ? touchEvent.touches[0].pageX : getMousePos(ev).x;
    var relPosY = (TouchManager.clickOrTouch(ev) === 'touchstart') ? touchEvent.touches[0].pageY : getMousePos(ev).y;
    console.log(ev);
    //get img class = "isf-el_collage__item"
    var newImg = this.allItems[this.itemSequenceCounter];
    var newImgWidth,
        newImgHeight;
    //if height or width are too much, resize
    if (newImg.naturalHeight > window.innerHeight/2){
        newImgHeight = window.innerHeight/2;
    } else {
        newImgHeight = newImg.naturalHeight;
    }

    newImgWidth = (newImgHeight / newImg.naturalHeight) * newImg.naturalWidth;
    newImg.style.width = newImgWidth;
    newImg.style.height = newImgHeight;

    var newImgPos = {
                        x : (relPosX - (newImgWidth/2)),
                        y : (relPosY - gridOffset - newImgHeight/2)
                    };

    self.items.push(new ISF_CollageItem(self.DOM.el.appendChild(newImg)));
    self.items[self.items.length-1].DOM.el.setAttribute("style", "top: " + newImgPos.y + "px; left: " + newImgPos.x + "px");

    this.itemSequenceCounter = (this.itemSequenceCounter < (this.allItems.length - 2)) ? (this.itemSequenceCounter + 1) : 0;


};

function ISF_CollageItem(el) {
    this.DOM = {el: el};
    //set a few vars for each item
    var randnum = getRandomInt(1, 150);
    this.DOM.el.dataset.minTy = -1*randnum;
    this.DOM.el.dataset.maxTy = -1*randnum;
    this.initEvents();
}

ISF_CollageItem.prototype.initEvents = function() {
    var self = this;
    setTimeout(function(){
        self.disappear();
    }, 2000);
...
ISF_CollageItem.prototype.disappear = function() {
    var speed = lineEq(1.3,0.9,4,50, this.DOM.el.dataset.maxTy);
    TweenMax.to(
        this.DOM.el,
        speed,
        {
...
module.exports = ISF_Collage;

},{"classes.js":39,"helpers/clickortouch.js":43,"helpers/getmousepos.js":46,"helpers/getrandomint.js":47,"helpers/lineeq.js":48,"helpers/shufflearray.js":51,"touchmanager.js":58}],67:[function(require,module,exports){
...
//an element to navigate through sections of the site

function ISF_Horizontal(el, controller) {

    this.controller = controller;

    this.DOM = {el: el};
    this.DOM.contents = this.DOM.el.querySelector(".isf-el_horizontal__content");

    this.init();
}

ISF_Horizontal.prototype.init = function() {
    //set height to match the width of content to last scrolling
    var contentRect = this.DOM.contents.getBoundingClientRect();
    var wh = window.innerHeight;
    this.DOM.el.style.height = (contentRect.width - wh - 2*contentRect.left) + "px";
    console.log((contentRect.width - wh - 2*contentRect.left) + "px", contentRect);

    var move = contentRect.width - contentRect.left;
    //find a more precise way to calculate x transform
    var wipeOut = new TimelineMax()
        .to(this.DOM.contents, 4, {x: -move });
...
module.exports = ISF_Horizontal;

},{"classes.js":39,"gsap":35,"helpers/getmousepos.js":46,"scrollmagic":37,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":38}],68:[function(require,module,exports){
...
function ISF_ImageGroup(el, controller) {
    this.controller = controller;
    this.DOM = {el: el};
    this.DOM.content = Array.from(el.querySelectorAll(CLASSES.IMAGE_GROUP.CONTENT));
    this.DOM.headerImg = el.querySelector(CLASSES.IMAGE_GROUP.HEADER_IMG);

    this.init();
}

ISF_ImageGroup.prototype.init = function() {
    if( this.DOM.headerImg ) {
        this.fixHeader();
    }
};

ISF_ImageGroup.prototype.fixHeader = function() {
    var self = this;
    var vh = window.innerHeight;

    this.headerScene = new ScrollMagic.Scene({
        triggerElement: this.DOM.el,
        triggerHook: 0,
        duration: this.DOM.el.offsetHeight - vh
    })
        .on("end", function (event) {
            self.DOM.el.classList.toggle(CLASSES.IMAGE_GROUP.JS__HEADER_BOTTOM);
        })
        .setClassToggle(this.DOM.el, CLASSES.IMAGE_GROUP.JS__HEADER_FIXED)
        .addTo(this.controller);

    this.titleScene = new ScrollMagic.Scene({
        triggerElement: this.DOM.content,
        triggerHook: 0.5,
        duration: this.DOM.el.offsetHeight - vh
    })
        .setClassToggle(this.DOM.el, CLASSES.IMAGE_GROUP.JS__TITLE_OUT)
        .addTo(this.controller);
};

ISF_ImageGroup.prototype.applyEffects = function(effects) {
    //the effects object looks something like
    //{ TRIGGER : EFFECT }
    var self = this;
    for ( var effect in effects ) {
        if(effects[effect]) {
            var func = effects[effect];
            var trigger = effect;
            //triggers that require an event listener
            self[func](trigger);
        }
    }
};
...
module.exports = ISF_ImageGroup;

},{"classes.js":39,"helpers/getmousepos.js":46,"scrollmagic":37}],69:[function(require,module,exports){
...
function ISF_Image(el, controller) {

    this.DOM = {el: el};
    this.DOM.wrap = el.querySelector(CLASSES.IMAGE.WRAPPER);
    ...
    this.applyEffects(self.effects);
}

ISF_Image.prototype.init = function() {
};

ISF_Image.prototype.applyEffects = function(effects) {
...
ISF_Image.prototype.bckgr= function() {
    var scene = new ScrollMagic.Scene({
        triggerElement: this.DOM.el,
        triggerHook: 0.5,
        duration: window.innerWidth
    })
        .setClassToggle(this.DOM.el, "is--onscreen")
        .addTo(this.controller);
};

// EFFECT ZOOMIN
ISF_Image.prototype.zoomin = function(trigger) {
    var self = this;
    this.DOM.el.addEventListener(trigger, function(ev) {
        TweenMax.to( self.DOM.img, 0.5,
            {
                scale: 1.05,
                ease: Sine.easeOut
        });
    ...
    if (trigger === "mouseover") {
        this.DOM.el.addEventListener("mouseout", function(ev) {
            TweenMax.to( self.DOM.img, 0.5,
                {
                    scale: 1,
                    ease: Sine.easeOut
...
// EFFECT TILT3D
// SYV BUGGY //
ISF_Image.prototype.tilt3d = function(trigger) {
    var self = this;
    var rect = self.DOM.el.getBoundingClientRect();
    var rectCentre = { x: (rect.x + rect.width/2),
                       y: (rect.y + rect.height/2)
                      };
    this.DOM.el.addEventListener(trigger, function(ev) {
        self.DOM.el.addEventListener("mousemove", function(ev) {
            var scrollTop = window.pageYOffset;
            var sxV = getMousePos().x - rectCentre.x;
            var syV = getMousePos().y - rectCentre.y - scrollTop;
            //console.log(sxV, syV);
            TweenMax.to( self.DOM.img, 3,
                {
                    rotationY: sxV*0.01,
                    rotationX: -syV*0.01,
                    rotationZ: 0,
...
// EFFECT INNER PARALLAX (Moves the image slightly within the wrapper)
ISF_Image.prototype.innerparallax = function() {
    //this tween also requires limiting the IMG EL height to original height - 200px, so no empty spaces appear
    var rect = this.DOM.el.getBoundingClientRect();
    var maxH = rect.height - 200 + "px";
    this.DOM.el.style.maxHeight = maxH;

    var ipTween = TweenMax.fromTo( this.DOM.img, 1,
        {y: -200 },
        {y: 0 }
    );
    this.innerParallaxScene = new ScrollMagic.Scene({
            triggerElement: this.DOM.el,
            triggerHook: 0.99,
            duration: window.innerWidth
        })
...
module.exports = ISF_Image;

},{"classes.js":39,"helpers/getmousepos.js":46,"scrollmagic":37}],70:[function(require,module,exports){

var ScrollMagic = require('scrollmagic');
var CLASSES = require('classes.js');
var winsize = require('helpers/calcwinsize.js');

function ISF_SplitSticky(el, controller) {
	this.DOM = {el: el};
    this.controller = controller;
    this.DOM.sticky = this.DOM.el.querySelector(".isf-el_split-sticky__sticky");
    this.initEvents();
}

ISF_SplitSticky.prototype.initEvents = function(){
    ...
    setTimeout(function() {
        ...
        self.scene = new ScrollMagic.Scene({
            ...
            .setClassToggle(self.DOM.el, "is--sticky")
            .on('start', function() {
                s1 = document.documentElement.scrollTop;
                self.DOM.sticky.classList.toggle("is--active");
            })
            .on('end', function() {
                self.DOM.el.classList.toggle("is--bottom");
                s2 = document.documentElement.scrollTop;
            })
...
module.exports = ISF_SplitSticky;

},{"classes.js":39,"helpers/calcwinsize.js":42,"scrollmagic":37}],71:[function(require,module,exports){

var CLASSES = require('classes.js');
var ScrollMagic = require('scrollmagic');

//modernizer for transitions
...
//figure out for mobile?
function ISF_TriggerVideo(el, controller) {

    this.controller = controller;

    this.DOM = {el: el};
    this.DOM.image = this.DOM.el.querySelector(".isf-el_image-background");
    //the target video overlay
    this.DOM.trgt = document.querySelector("#" + this.DOM.el.dataset.trigger);
    this.DOM.trgtClose = this.DOM.trgt.querySelector(".isf-button--close");

    this.init();
}

ISF_TriggerVideo.prototype.init = function() {
    var self = this;
    this.activeScene = new ScrollMagic.Scene({
            triggerElement: self.DOM.el,
            triggerHook: 0
        })
            .on("start", function() {
                self.DOM.el.classList.add("is--enabled");
            })
            .addTo(this.controller);
    ...
    this.DOM.el.addEventListener( 'click', function(e) {
        e.preventDefault();
        console.log(self);
        var target = self.DOM.el.dataset.trigger;
        self.DOM.el.classList.add("is--animating");

        /* Listen for a transition! */
        var transitionEvent = whichTransitionEvent();
        transitionEvent && self.DOM.image.addEventListener(transitionEvent, tEnd);

        function tEnd(){
            self.DOM.el.classList.add("is--animated");
            self.DOM.trgt.classList.add("is--open");
            self.DOM.image.removeEventListener(transitionEvent, tEnd);
        }
    });
    this.DOM.trgtClose.addEventListener( 'click', function(e) {
        e.preventDefault();
        self.DOM.trgt.classList.remove("is--open");
        self.DOM.el.classList.remove("is--animating");
        self.DOM.el.classList.remove("is--animated");
    });
};
...
module.exports = ISF_TriggerVideo;

},{"browsernizr":1,"browsernizr/test/css/rgba":30,"browsernizr/test/file/filesystem":31,"browsernizr/test/websockets":32,"classes.js":39,"scrollmagic":37}],72:[function(require,module,exports){
...
( function(window) {
  ...
  var CLASSES = require('classes.js');
  var ISF_TouchManager = require('touchmanager.js'); //dest
  var getMousePos = require('helpers/getmousepos.js');
  var mapRange = require('helpers/mapRange.js');

  /* ELEMENTS */
  // Pick only the ones you need
  var ISF_El = require('../../src/modules/elements/basic/script.js');
  var ISF_Image = require('../../src/modules/elements/image/script.js');
  var ISF_ImageGroup = require('../../src/modules/elements/image-group/script.js');
  var ISF_Horizontal = require('../../src/modules/elements/horizontal/script.js');
  var ISF_Chapter = require('../../src/modules/elements/chapter/script.js');
  var ISF_Collage = require('../../src/modules/elements/collage/script.js');
  var ISF_SplitSticky = require('../../src/modules/elements/split-sticky/script.js');
  var ISF_TriggerVideo = require('../../src/modules/elements/trigger-video/script.js');

  /* EFFECTS */
  // var effectTilt = require('./modules/effects/tilt.js');
  var ISF_X_PageEnter = require('../../src/modules/effects/isf_animate-page-enter/script.js');
  var ISF_X_Parallax = require('../../src/modules/effects/isf_parallax/script.js');
  var ISF_X_BlockReveal = require('../../src/modules/effects/isf_block-reveal/script.js');
  var ISF_X_Letters = require('../../src/modules/effects/isf_letters/script.js');

  var ISF_X_Rain= require('../../src/modules/effects/isf_rain/script.js');
  /* STORY SPECIFIC */
  ...
  function InteractivePage(el) {
    ...
    // effects
    this.effects = {};
    this.effects.isf_animate_on_page_enter = ISF_X_PageEnter;
    this.effects.isf_parallax = ISF_X_Parallax;
    this.effects.isf_block_reveal = ISF_X_BlockReveal;
    this.effects.isf_letters = ISF_X_Letters;
    this.effects.isf_rain = ISF_X_Rain;
    // Settings for the Letters Effect
    this.effects.isf_letters.opts = {
      duration: 0.1, // duration per letter
    };

    // Settings for the block revealer elementsdsds
    // direction: lr, rl, tb, bt
    this.effects.isf_block_reveal.opts = {
      revealSettings: {
        direction: 'lr',
        bgcolor: '#e69fa9',
        duration: 0.5,
    ...
    this.hoverItems = Array.from(document.querySelectorAll(".isf-el_grid__item"));
  ...
  InteractivePage.prototype.init = function() {
    ...
    // INIT Images
    this.elems.imgs = [];
    Array.from(this.DOM.story.querySelectorAll(CLASSES.IMAGE.CONTAINER)).forEach(function(item) {
      self.elems.imgs.push(new ISF_Image(item, controller));
    });

    // INIT Image Groups
    self.elems.imageGroups = [];
    Array.from(this.DOM.story.querySelectorAll(CLASSES.IMAGE_GROUP.CONTAINER)).forEach(function(item) {
      self.elems.imageGroups.push(new ISF_ImageGroup(item, controller));
    });

    // INIT Chapters
    self.elems.chapters = [];
    Array.from(document.querySelectorAll(CLASSES.CHAPTER.CONTAINER)).forEach(function(item) {
      self.elems.chapters.push(new ISF_Chapter(item, controller));
    });

    // document.querySelector( ".isf-el_image-section" ).addEventListener( "mousemove", function(e) {
    //     var mpos = getMousePos(e);
    //     var dx = - mapRange(mpos.x, 0, window.innerWidth, -10, 10);
    //     var dy = - mapRange(mpos.y, 0, window.innerHeight, -10, 10);
    //     TweenMax.to( document.querySelector( ".isf-el_image-section__image" ), 1, {
    //         x: dx + 'vw',
    //         y: dy + 'vh',
    //         ease: Power3.easeOut
    //     });
    ...
    var scTween = TweenMax.fromTo( document.querySelector( ".isf-el_image-section__image" ), 1,
        {
            y: '8vh'
        },
        {
    ...
    var sc = new ScrollMagic.Scene({
        triggerElement: document.querySelector( ".isf-el_image-section" ),
        triggerHook: 0.99,
        duration: 2*(document.querySelector( ".isf-el_image-section" ).offsetHeight)
      })
        .on('enter', function() {
            console.log("enters");
        })
    ...
    var rainEl = document.querySelector( "#rain" );
    self.effects.isf_rain(rainEl, controller, {});
    /* INIT Effects */
    Object.entries(self.elems).forEach(function(elemgroup) {
      var key = elemgroup[0];
      var arr = elemgroup[1];
      arr.forEach(function(elem) {
        var data = elem.DOM.el.dataset;
        for (var attr in data) {
          // it's important that in the object it has the same name
          if ( data[attr] && self.effects[attr] ) {
            // options here override the defaults
            if ( self.effects[attr].opts ) {
              self.effects[attr].opts.fx = data[attr];
            }
            self.effects[attr](elem, controller, self.effects[attr].opts);
          }
        }
      });
    });
...
},{"../../src/modules/effects/isf_animate-page-enter/script.js":59,"../../src/modules/effects/isf_block-reveal/script.js":60,"../../src/modules/effects/isf_letters/script.js":61,"../../src/modules/effects/isf_parallax/script.js":62,"../../src/modules/effects/isf_rain/script.js":63,"../../src/modules/elements/basic/script.js":64,"../../src/modules/elements/chapter/script.js":65,"../../src/modules/elements/collage/script.js":66,"../../src/modules/elements/horizontal/script.js":67,"../../src/modules/elements/image-group/script.js":68,"../../src/modules/elements/image/script.js":69,"../../src/modules/elements/split-sticky/script.js":70,"../../src/modules/elements/trigger-video/script.js":71,"classes.js":39,"gsap":35,"helpers/getmousepos.js":46,"helpers/mapRange.js":49,"helpers/removebadthings.js":50,"imagesLoaded":36,"scrollmagic":37,"scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap":38,"touchmanager.js":58}]},{},[72]);
